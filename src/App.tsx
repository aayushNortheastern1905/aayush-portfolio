  ...
  const projects = [
    {
      ...
      github: "https://github.com/aayushNortheastern1905",
    ...
    <div className="min-h-screen bg-white text-black relative" style={{ fontFamily: 'Monaco, "Courier New", monospace' }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-8 py-6 flex justify-between items-center">
          <div className="text-2xl font-bold tracking-tight">AAYUSH_SAWANT</div>
          <div className="flex space-x-12">
            {['About', 'Projects', 'Experience', 'Contact'].map((item) => (
              <a 
                key={item}
                href={`#${item.toLowerCase()}`}
                className="text-gray-600 hover:text-black transition-all duration-300 text-sm tracking-widest uppercase"
          ...
          <div className="space-y-12">
            <div className="space-y-8">
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-light tracking-tighter leading-tight">
                <span className="block mb-4">FULL_STACK</span>
                <span className="block text-gray-400">ENGINEER</span>
              </h1>
              <p className="text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed tracking-wide">
              ...
              <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                IEEE Research • Healthcare Automation • Community Platforms • Professional Writer
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-16 border-t border-gray-200">
              {metrics.map((metric, index) => (
                <div key={index} className="text-center space-y-2">
                  ...
                  <div className="text-sm text-gray-500 uppercase tracking-widest">{metric.label}</div>
            ...
            <div className="flex justify-center space-x-6 pt-12">
              <a 
                href="#projects" 
                className="px-12 py-4 border-2 border-black hover:bg-black hover:text-white transition-all duration-300 text-sm tracking-widest uppercase"
              >
                View_Projects
              </a>
              <a 
                href="#contact" 
                className="px-12 py-4 bg-black text-white hover:bg-gray-800 transition-all duration-300 text-sm tracking-widest uppercase"
              >
                Contact_Me
              </a>
            </div>
      ...
      <section id="about" className="py-32 bg-gray-50 scroll-mt-24">
        <div className="max-w-6xl mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-20 items-start">
            <div>
              <h2 className="text-5xl font-light mb-12 tracking-tighter">ABOUT_ME</h2>
              <div className="space-y-6 text-gray-600 leading-relaxed">
                ...
                <p>
                  Currently completing software co-op at EmTech Care Labs, building healthcare automation 
                  systems while developing community platforms that serve 500+ users.
                </p>
              </div>
              
              <div className="pt-12">
                <h3 className="text-xl font-bold tracking-widest uppercase mb-8">Technical_Stack</h3>
                    ...
                    <div key={skillGroup.category}>
                      ...
                      <div className="flex flex-wrap gap-3">
                        {skillGroup.items.map((skill) => (
                          <span 
                            key={skill}
                            className="px-4 py-2 border border-gray-300 text-xs tracking-wide hover:border-black hover:bg-black hover:text-white transition-all duration-200"
                          >
                            {skill}
                          </span>
                        ))}
            ...
            <div className="space-y-8">
              <div className="bg-white p-8 border border-gray-200 hover:border-black transition-all duration-300">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <span className="text-sm uppercase tracking-widest">Current_Focus</span>
                </div>
                <div className="text-sm text-gray-600 space-y-2">
                  <div>• Healthcare automation systems at EmTech</div>
                  <div>• Community platform scaling (VeryDesi)</div>
              ...
              <div className="bg-white p-8 border border-gray-200 hover:border-black transition-all duration-300">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <span className="text-sm uppercase tracking-widest">Writing_Portfolio</span>
                </div>
                <div className="text-sm text-gray-600 space-y-2">
              ...
              <div className="bg-white p-8 border border-gray-200 hover:border-black transition-all duration-300">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <span className="text-sm uppercase tracking-widest">Research_Impact</span>
                </div>
                <div className="text-sm text-gray-600 space-y-2">
      ...
      <section id="projects" className="py-32 bg-white scroll-mt-24">
        <div className="max-w-7xl mx-auto px-8">
          <h2 className="text-5xl font-light mb-20 tracking-tighter text-center">SELECTED_WORK</h2>
            ...
            {projects.map((project, index) => (
              ...
              >
                <div className="md:col-span-2 space-y-6">
                  ...
                  <div className="text-sm font-bold text-gray-800">{project.impact}</div>
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech) => (
                      <span 
                        key={tech}
                        className="px-3 py-1 text-xs border border-gray-300 text-gray-600 tracking-wide"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="flex space-x-6 pt-4">
                    <a 
                      ...
                      className="text-sm text-gray-500 hover:text-black transition-colors duration-200 flex items-center space-x-2 uppercase tracking-wide"
                    >
                ...
                <div className="md:col-span-3">
                  <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 border border-gray-200 group-hover:border-black transition-all duration-500 relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-black/5 to-transparent group-hover:from-black/10 transition-all duration-500" />
                    <div className="absolute bottom-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <div className="flex space-x-2">
                        <a href={project.live} target="_blank" rel="noopener noreferrer" className="p-3 bg-white/90 backdrop-blur-sm border hover:bg-black hover:text-white transition-colors">
                          <ExternalLink className="w-4 h-4" />
                        </a>
                        <a href={project.github} target="_blank" rel="noopener noreferrer" className="p-3 bg-white/90 backdrop-blur-sm border hover:bg-black hover:text-white transition-colors">
                          <Github className="w-4 h-4" />
                        </a>
                      </div>
                    </div>
      ...
      <section id="experience" className="py-32 bg-gray-50 scroll-mt-24">
        <div className="max-w-6xl mx-auto px-8">
          <h2 className="text-5xl font-light mb-20 tracking-tighter text-center">EXPERIENCE</h2>
          <div className="space-y-16">
            {experience.map((job, index) => (
              <div key={index} className="border-l-2 border-gray-300 pl-8 relative">
                <div className="absolute -left-2 top-0 w-3 h-3 bg-black rounded-full"></div>
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="text-2xl font-light tracking-tight">{job.company}</h3>
                      <div className="text-lg text-gray-600">{job.role}</div>
                    </div>
                    <div className="text-right text-sm text-gray-500">
                      <div className="uppercase tracking-widest">{job.period}</div>
            ...
            <div className="border-l-2 border-gray-300 pl-8 relative">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-2xl font-light tracking-tight">COEP Technological University</h3>
                    <div className="text-lg text-gray-600">Research & Development</div>
                  </div>
                  <div className="text-right text-sm text-gray-500">
                    <div className="uppercase tracking-widest">2017 - 2021</div>
                    <div>Pune, India</div>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="text-gray-600 text-sm leading-relaxed">
                    • Published IEEE research on voice-operated wheelchair systems
                  </div>
                  <div className="text-gray-600 text-sm leading-relaxed">
                    • Developed accessibility technology solutions
                  </div>
                  <div className="text-gray-600 text-sm leading-relaxed">
      ...
      <section id="education" className="py-32 bg-white scroll-mt-24">
        <div className="max-w-6xl mx-auto px-8">
          <h2 className="text-5xl font-light mb-20 tracking-tighter text-center">EDUCATION</h2>
          <div className="grid md:grid-cols-2 gap-12">
            {education.map((edu, index) => (
              <div key={index} className="bg-gray-50 p-8 border border-gray-200 hover:border-black transition-all duration-300">
                <h3 className="text-xl font-light tracking-tight mb-2">{edu.institution}</h3>
                <div className="text-lg text-gray-600 mb-4">{edu.degree}</div>
                <div className="flex justify-between items-center mb-4 text-sm text-gray-500">
                  <span className="uppercase tracking-widest">{edu.period}</span>
                  <span>GPA: {edu.gpa}</span>
                </div>
                <div className="text-xs text-gray-500 mb-4">{edu.location}</div>
                <div className="space-y-1">
                  {edu.coursework.map((course) => (
                    <div key={course} className="text-sm text-gray-600">• {course}</div>
                  ))}
                </div>
              </div>
            ))}
      ...
      <section id="writing" className="py-32 bg-gray-50 scroll-mt-24">
        <div className="max-w-6xl mx-auto px-8">
          <h2 className="text-5xl font-light mb-20 tracking-tighter text-center">WRITING_PORTFOLIO</h2>
          <div className="grid md:grid-cols-2 gap-16">
            <div className="space-y-8">
              <div className="bg-white border border-gray-200 p-8 hover:border-black transition-all duration-300">
                <h3 className="text-xl font-light tracking-tight mb-4">The Huntington News</h3>
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-gray-500 hover:text-black transition-colors flex items-center space-x-2 uppercase tracking-wide"
                >
            ...
            <div className="space-y-8">
              <div className="bg-white border border-gray-200 p-8 hover:border-black transition-all duration-300">
                <h3 className="text-xl font-light tracking-tight mb-4">Personal Blog</h3>
                <p className="text-gray-600 text-sm leading-relaxed mb-6">
        ...
        <div className="max-w-4xl mx-auto px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              >
                <div className="border border-gray-700 p-8 hover:border-white transition-all duration-300 group-hover:bg-white group-hover:text-black">
                  <Icon className="w-8 h-8 mx-auto mb-4" />
                  <div className="text-sm uppercase tracking-widest mb-2">{label}</div>
                  <div className="text-xs text-gray-400 group-hover:text-gray-600">{value}</div>
                </div>
              </a>
            ))}
          </div>
          ...
          <div className="pt-16 text-sm text-gray-500 space-y-2">
            <div className="uppercase tracking-widest">Phone</div>
