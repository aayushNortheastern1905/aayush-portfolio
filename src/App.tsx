...
const Portfolio = () => {
 ...
 const roles = ['SOFTWARE ENGINEER', 'INNOVATOR', 'WRITER', 'AI_ENTHUSIAST'];
         ...
         <div className="space-y-12">
           <div className="space-y-8">
             <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-light tracking-tighter leading-tight">
               <span className="block text-gray-400 min-h-[1.2em]">
                 {currentRole}
             ...
             >
               <div className="md:col-span-2 space-y-6">
                 ...
                 <div className="flex space-x-6 pt-4">
                   ...
                   <span className="text-sm text-gray-400 flex items-center space-x-2 uppercase tracking-wide">
               ...
               <div className="md:col-span-3">
                 <div className="aspect-video bg-white border border-gray-200 group-hover:border-black transition-all duration-500 relative overflow-hidden">
                   <img 
                     src={project.image} 
